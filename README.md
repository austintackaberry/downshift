...
If a `disabled` property is passed and set to `true`, then the downshift button
event handlers will be disabled. The menu will not be toggled on click or when
the Space key is pressed. You should probably override this yourself so you can
